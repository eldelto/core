...
func TestAssemble(t *testing.T) {
	tests := []struct {
		...
		{"valid program",
			...
			[]byte{7, 255, 255, 255, 255, 4, 0, 0, 0, 26, 0, 0, 0, 0, 0, 6, 100, 111, 117, 98, 108, 101, 8, 8, 19, 2, 7, 0, 0, 0, 11, 5, 0, 0, 0, 22, 1},
			false},
		{"mixed assembly and calls",
			"const 0 .codeword rpush rpush .end .codeword main const 5 call @rpush exit .end",
			[]byte{7, 0, 0, 0, 0, 0, 0, 0, 0, 0, 5, 114, 112, 117, 115, 104, 12, 2, 0, 0, 0, 5, 0, 4, 109, 97, 105, 110, 7, 0, 0, 0, 5, 5, 0, 0, 0, 16, 1, 2},
			false},
	}
